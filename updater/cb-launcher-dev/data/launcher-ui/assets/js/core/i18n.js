    ...
    const translations = {
        en: {
            cb: {
                ...
                handleTaken: 'That handle is already taken. If it is yours from another device, use your recovery code below.',
                recoverLink: 'Already have a CB profile? Use a recovery code',
                recoverTitle: 'Recover your CB profile',
                recoverSub: 'Enter the recovery code you saved when the profile was created. This device will be added to that account.',
                recoverHint: '32 characters, shown once when you created the profile. Dashes and case do not matter.',
                recoverBtn: 'Recover profile',
                recoverInvalid: 'That does not look like a recovery code. It should be 8 groups of 4 letters or numbers.',
                recoverNoAccount: 'No profile matches that recovery code.',
                recoverRateLimited: 'Too many recovery attempts. Try again in an hour.',
                edit: 'Edit',
                ...
                mutePermanentTitle: 'Mute @{{handle}} permanently?',
                mutePermanentBody: 'They will not be able to chat, send messages or post to the board until a moderator unmutes them.',
                deleteMessage: 'Delete message',
                purgeMessages: 'Delete all their messages here',
                purgeRoom: 'Delete all in room',
                purgeTitle: 'Delete all messages from @{{handle}}?',
                purgeBody: 'Removes every message they still have in {{room}} chat. This cannot be undone.',
                purgeConfirm: 'Delete all',
                messageDeleted: 'Message deleted',
                inRoomChat: 'In {{room}} chat',
                profileAsReported: 'Profile when reported',
                ...
                reportMessageTitle: 'Report message from @{{handle}}',
                reportMessageBody: 'The message and the few lines before it go to the CB Servers team for review.',
                reportWhy: 'What is the problem?',
                reportNotePlaceholder: 'Anything the moderators should know (optional)',
                reportCategories: {
                    harassment: 'Harassment or hate',
                    spam: 'Spam or advertising',
                    cheating: 'Cheating',
                    profile: 'Inappropriate name or profile',
                    other: 'Something else'
                },
                reportConfirm: 'Report',
                reportedToast: 'Report sent. Thanks.',
                mutedBanner: "You're muted until {{when}}.",
                mutedBannerPermanent: "You're muted.",
                mutedReason: 'Reason: {{reason}}',
                mutedNoPost: "You can't post to the board while you're muted.",
                ...
                inviteGroupHint: 'You can invite your group once you are hosting a joinable match.',
                joinedWaitInvite: 'Joined. A friend request was sent, wait for their invite.',
                joinedSayHi: 'Joined. A friend request was sent, say hi in {{game}} chat.',
                joinedYourGroupTitle: 'Someone joined your group',
                joinedYourGroup: '{{name}} joined your {{game}} group.'
            },
            app: {
            ...
            settings: {
                ...
                parallelDownloadsBody: 'Downloads several game files at once on SSD installs. Turn this off if downloads fail or stall on your network. Hard drives always download one file at a time.',
            ...
            detail: {
                ...
                credits: 'Credits',
                note: 'Note',
                noteBody: 'This launcher is not affiliated with or endorsed by {{provider}}. Please do not contact the original client maintainers with support requests regarding this launcher, use our <a href="https://discord.gg/WyJQCwCCGW" target="_blank">Discord</a> instead.',
            ...
            popup: {
                ...
                gameSettings: {
                    ...
                    plutoniumLan: 'LAN mode',
                    plutoniumLanHelp: 'Starts the game without a Plutonium account. Online servers are unavailable.',
                    player: 'Player',
                    playerNameOverride: 'In-game name override',
                    playerNameOverrideHelp: 'Overrides the global in-game name for this game.',
                    playerNameOverrideHelpLan: 'Used in LAN mode only. Overrides the global in-game name for this game.',
        ...
        fr: {
            ...
            settings: {
                ...
                parallelDownloads: 'Telechargements paralleles',
                parallelDownloadsBody: "Telecharge plusieurs fichiers du jeu en meme temps sur les installations SSD. Desactivez cette option si les telechargements echouent ou se bloquent sur votre reseau. Les disques durs telechargent toujours un fichier a la fois.",
            ...
            detail: {
                ...
                credits: 'Credits',
                note: 'Note',
                noteBody: "Ce launcher n'est ni affilie ni approuve par {{provider}}. Merci de ne pas contacter les developpeurs des clients d'origine pour des demandes de support concernant ce launcher, utilisez plutot notre <a href=\"https://discord.gg/WyJQCwCCGW\" target=\"_blank\">Discord</a>.",
            ...
            popup: {
                ...
                gameSettings: {
                    ...
                    plutoniumLan: 'Mode LAN',
                    plutoniumLanHelp: 'Lance le jeu sans compte Plutonium. Les serveurs en ligne sont indisponibles.',
                    player: 'Joueur',
                    playerNameOverride: 'Nom personnalise pour ce jeu',
                    playerNameOverrideHelp: 'Remplace le nom global pour ce jeu.',
                    playerNameOverrideHelpLan: 'Utilisé en mode LAN uniquement. Remplace le nom global pour ce jeu.',
        ...
        es: {
            ...
            settings: {
                ...
                parallelDownloads: 'Descargas en paralelo',
                parallelDownloadsBody: 'Descarga varios archivos del juego a la vez en instalaciones SSD. Desactivalo si las descargas fallan o se detienen en tu red. Los discos duros siempre descargan un archivo a la vez.',
            ...
            detail: {
                ...
                credits: 'Creditos',
                note: 'Nota',
                noteBody: 'Este launcher no esta afiliado ni respaldado por {{provider}}. Por favor, no contactes a los desarrolladores originales de los clientes con consultas de soporte sobre este launcher, usa nuestro <a href="https://discord.gg/WyJQCwCCGW" target="_blank">Discord</a> en su lugar.',
            ...
            popup: {
                ...
                gameSettings: {
                    ...
                    plutoniumLan: 'Modo LAN',
                    plutoniumLanHelp: 'Inicia el juego sin cuenta de Plutonium. Los servidores en línea no están disponibles.',
                    player: 'Jugador',
                    playerNameOverride: 'Nombre personalizado en el juego',
                    playerNameOverrideHelp: 'Sobrescribe el nombre global para este juego.',
                    playerNameOverrideHelpLan: 'Solo en modo LAN. Sobrescribe el nombre global para este juego.',
        ...
        ru: {
            ...
            settings: {
                ...
                parallelDownloads: 'Параллельная загрузка',
                parallelDownloadsBody: 'Загружает несколько файлов игры одновременно при установке на SSD. Отключите, если загрузки прерываются или зависают в вашей сети. На жёстких дисках файлы всегда загружаются по одному.',
            ...
            detail: {
                ...
                credits: 'Авторы',
                note: 'Примечание',
                noteBody: 'Этот лаунчер не связан и не одобрен {{provider}}. Пожалуйста, не обращайтесь к разработчикам оригинальных клиентов с вопросами поддержки по этому лаунчеру, используйте наш <a href="https://discord.gg/WyJQCwCCGW" target="_blank">Discord</a>.',
            ...
            popup: {
                ...
                gameSettings: {
                    ...
                    plutoniumLan: 'Режим LAN',
                    plutoniumLanHelp: 'Запускает игру без аккаунта Plutonium. Онлайн-серверы недоступны.',
                    player: 'Игрок',
                    playerNameOverride: 'Имя для этой игры',
                    playerNameOverrideHelp: 'Переопределяет глобальное имя для этой игры.',
                    playerNameOverrideHelpLan: 'Только в режиме LAN. Переопределяет глобальное имя для этой игры.',
