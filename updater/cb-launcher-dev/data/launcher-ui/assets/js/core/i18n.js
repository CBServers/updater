    ...
    const translations = {
        en: {
            ...
            settings: {
                ...
                portableModeBody: 'Keeps launcher data and settings in a cbservers folder next to the launcher exe instead of AppData. Same as the -portable flag. Switching copies your data to the new location and restarts the launcher.',
                ...
                portableConfirmBody: 'Your settings, clients and mod receipts will be copied to the new location and the launcher will restart. Caches are rebuilt on first use. Continue?',
                portableFailed: 'Could not copy launcher data. Nothing was changed.',
        ...
        fr: {
            ...
            settings: {
                ...
                portableModeBody: "Conserve les donnees et parametres du launcher dans un dossier cbservers a cote de l'executable au lieu d'AppData. Equivalent de l'option -portable. Le changement copie vos donnees vers le nouvel emplacement et redemarre le launcher.",
                ...
                portableConfirmBody: 'Vos parametres, clients et recus de mods seront copies vers le nouvel emplacement et le launcher redemarrera. Les caches seront reconstruits a la premiere utilisation. Continuer ?',
                portableFailed: "Impossible de copier les donnees du launcher. Rien n'a ete modifie.",
        ...
        es: {
            ...
            settings: {
                ...
                portableModeBody: 'Guarda los datos y ajustes del launcher en una carpeta cbservers junto al ejecutable en lugar de AppData. Equivale a la opcion -portable. Al cambiar se copian tus datos a la nueva ubicacion y el launcher se reinicia.',
                ...
                portableConfirmBody: 'Tus ajustes, clientes y recibos de mods se copiaran a la nueva ubicacion y el launcher se reiniciara. Las caches se reconstruyen al primer uso. Continuar?',
                portableFailed: 'No se pudieron copiar los datos del launcher. No se cambio nada.',
        ...
        ru: {
            ...
            settings: {
                ...
                portableModeBody: 'Хранит данные и настройки лаунчера в папке cbservers рядом с exe вместо AppData. То же, что флаг -portable. При переключении данные копируются в новое место и лаунчер перезапускается.',
                ...
                portableConfirmBody: 'Настройки, клиенты и данные модов будут скопированы в новое место, и лаунчер перезапустится. Кэши создадутся заново при первом использовании. Продолжить?',
                portableFailed: 'Не удалось скопировать данные лаунчера. Ничего не изменено.',
